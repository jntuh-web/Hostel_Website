...
const variableItemSchema = new mongoose.Schema({
    id: {
        type: Number,
        default: 0,
    },
...
variableItemSchema.pre('save', async function (next) {
    try {
...
module.exports = mongoose.module("Variable-items", variableItemSchema)